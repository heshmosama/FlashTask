...
class AssumeServiceAmountResponse {
  ...
  AssumeServiceAmountResponse({this.assumeServicePeriod, this.totalOfBasicSalaryAndSocialAllowanceOnTheDateOfRequest});

  factory AssumeServiceAmountResponse.fromJson(Map<String, dynamic> json) => _$AssumeServiceAmountResponseFromJson(json);
